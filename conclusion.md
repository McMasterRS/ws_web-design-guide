...
If you want to learn how to create and style the Next.js SPA used in this demo from scratch, please consult the [Building Modern Single-Page Applications](https://mcmasterrs.github.io/lm_building-modern-SPAs/) learning module. 

If you require additional help with building your website or if you happen to use a different tech stack or framework than the ones covered in this workshop, please feel free to book a consultation with the Research Software Development team by emailing [rsd@mcmaster.ca](mailto:rsd@mcmaster.ca).
